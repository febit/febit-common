...
class Tuple3Test {
    ...
    @Test
    void test() {
        var numbers = Tuple3.of(1, 2, 3);
        var mixed = Tuple3.of(1, "2", 3L);
    ...
    void testCompareTo() {
        ...
        assertEquals(1, numbers.compareTo(Tuple3.of(0, 2, 3)));
        assertEquals(1, numbers.compareTo(Tuple3.of(1, 1, 3)));
        assertEquals(1, numbers.compareTo(Tuple3.of(1, 2, 2)));

        assertEquals(-1, numbers.compareTo(Tuple3.of(2, 2, 3)));
        assertEquals(-1, numbers.compareTo(Tuple3.of(1, 3, 3)));
        assertEquals(-1, numbers.compareTo(Tuple3.of(1, 2, 4)));
    }
}
