...
- jackson 3.1.4 → 3.2.0, jooq 3.19.33 → 3.21.5
- spring-boot 4.0.7 → 4.1.0
- okhttp 5.3.2 → 5.4.0, spotbugs 4.9.8 → 4.10.2
- Added jetcd 0.8.6, testcontainers 2.0.5, protobuf 4.35.1, h2database 2.4.240
...
- Gradle 9.4.1 → 9.5.1
- jackson 3.1.2 → 3.1.4, spring-boot 4.0.6 → 4.0.7
- kafka-clients 4.2.0 → 4.3.0, junit 6.0.3 → 6.1.0
...
- febit-devkit → 1.6.1, upgraded Gradle and library dependencies
...
- jackson 3.0.4 → 3.1.0, jsonpath 2.10.0 → 3.0.0
- spring 7.0.3 → 7.0.6, spring-boot 4.0.2 → 4.0.3
