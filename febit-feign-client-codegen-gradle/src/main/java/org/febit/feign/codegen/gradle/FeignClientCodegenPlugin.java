...
public class FeignClientCodegenPlugin implements Plugin<Project> {
    ...
    public void apply(Project proj) {
        ...
        proj.getExtensions()
                .create(Constants.EXT_NAME, FeignClientCodegenExtension.class, proj);

        proj.getTasks()
                .register(Constants.TASK_GEN_CLIENT, FeignClientCodegenExtensionTask.class);
