...
import org.febit.feign.codegen.util.ClassNamingImpl;
...
public class FeignClientCodegenExtension {
    ...
    @Inject
    public FeignClientCodegenExtension(Project project) {
        this.targetSourceDir = new File(project.getBuildDir(),
                "generated/sources/codegen-feign-client");
    }
