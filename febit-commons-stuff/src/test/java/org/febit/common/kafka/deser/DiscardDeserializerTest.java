...
class DiscardDeserializerTest {

    private final DiscardDeserializer<Object> deserializer = new DiscardDeserializer<>();

    @Test
    void shouldReturnNullForAnyData() {
        assertNull(deserializer.deserialize("topic", new byte[]{1, 2, 3}));
    }
